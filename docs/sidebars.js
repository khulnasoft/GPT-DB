      ...
      items: [
        ...
        },
        {
          ...
          link: {
            ...
            description: 'Example code for accomplishing common workflow with the Agentic Workflow Expression Language (AWEL). These examples show how to build  different app use LLMs (the core AWEL interface) and gptdb modules.',
            slug: "awel/cookbook"
          },
        },
        {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              type: 'doc',
              id: 'application/fine_tuning_manual/gptdb_hub',
            },
          ],
        },
      ],
