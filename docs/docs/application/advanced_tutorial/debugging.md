# Debugging
GPT-DB provides a series of tools to help developers troubleshoot and solve some problems they may encounter.

## View Trace Logs With Command

GPT-DB writes some key system runtime information to trace logs. By default, they are located in `logs/gptdb*.jsonl`.


GPT-DB also provides a command line tool `gptdb trace` to help analyze these trace logs. You can check the specific usage through the following command:
...
## View chat details
You can view chat details through the `gptdb trace chat` command. By default, the latest conversation information is displayed.


## View service runtime information
```python
gptdb trace chat --hide_conv
```
...
```python
gptdb trace chat --hide_run_params
```
The output is as follows:
```python
+-------------------------------------------------------------------------------------------------------------------------------------------+
...
```python
gptdb trace chat --hide_run_params --tree
```
The output is as follows:
```python
...
Operation: GPT-DB-Web-Entry (Start: 2023-10-12 03:06:43.180, End: None)
...
Operation: GPT-DB-Web-Entry (Start: 2023-10-12 03:06:43.180, End: 2023-10-12 03:06:43.257)
+-------------------------------------------------------------------------------------------------------------------------------------------+
|                                                             Chat Trace Details                                                            |
+----------------+--------------------------------------------------------------------------------------------------------------------------+
|      Key       |                                                       Value Value                                                        |
...
```python
gptdb trace chat --hide_run_params --trace_id ec30d733-7b35-4d61-b02e-2832fd2e29ff
```
The output is as follows:
```python
+-------------------------------------------------------------------------------------------------------------------------------------------+
...
```python
# command
gptdb trace chat --help

# output
Usage: gptdb trace chat [OPTIONS] [FILES]...
...
The output is as follows:
```python
Operation: GPT-DB-Web-Entry (Start: 2023-10-12 03:22:10.592, End: None)
...
Operation: GPT-DB-Web-Entry (Start: 2023-10-12 03:22:10.592, End: 2023-10-12 03:22:10.673)
```
...
```python
gptdb trace list --span_type chat
...
```python
gptdb trace list --help

Usage: gptdb trace list [OPTIONS] [FILES]...
