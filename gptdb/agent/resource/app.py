...
from gptdb.agent import AgentMessage, ConversableAgent
from gptdb.util import ParameterDescription

from .base import Resource, ResourceParameters, ResourceType


def _get_app_list():
    # TODO: Don't import gptdb.serve in gptdb.agent module
    from gptdb.serve.agent.agents.app_agent_manage import get_app_manager

    # Only call this function when the system app is initialized
    apps = get_app_manager().get_gptdbs()
    results = [
        {
