...
class CodeAssistantAgent(ConversableAgent):
    ...
    profile: ProfileConfig = ProfileConfig(
        name=DynConfig(
            "Turing",
            category="agent",
            key="gptdb_agent_expand_code_assistant_agent_profile_name",
        ),
        role=DynConfig(
            "CodeEngineer",
            category="agent",
            key="gptdb_agent_expand_code_assistant_agent_profile_role",
        ),
        goal=DynConfig(
            ...
            category="agent",
            key="gptdb_agent_expand_code_assistant_agent_profile_goal",
        ),
        constraints=DynConfig(
            ...
            category="agent",
            key="gptdb_agent_expand_code_assistant_agent_profile_constraints",
        ),
        desc=DynConfig(
            "Can independently write and execute python/shell code to solve various"
            " problems",
            category="agent",
            key="gptdb_agent_expand_code_assistant_agent_profile_desc",
        ),
    )
