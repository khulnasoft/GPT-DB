...
from gptdb.serve.prompt.api.endpoints import get_service
...
@register_resource(
    ...
    alias=[
        "gptdb.serve.agent.team.layout.agent_operator_resource.AwelAgentResource",
...
def _agent_resource_knowledge_values(
    ...
    from gptdb.app.knowledge.api import knowledge_space_service
    from gptdb.app.knowledge.request.request import KnowledgeSpaceRequest
...
@register_resource(
    ...
    alias=[
        "gptdb.serve.agent.team.layout.agent_operator_resource.AwelAgentKnowledgeResource",  # noqa
        "gptdb.agent.core.plan.awel.agent_operator_resource.AWELAgentKnowledgeResource",
    ],
)
...
@register_resource(
    ...
    alias=[
        "gptdb.serve.agent.team.layout.agent_operator_resource.AgentPrompt",
        "gptdb.agent.core.plan.awel.agent_operator_resource.AgentPrompt",
    ],
)
...
@register_resource(
    ...
    alias=[
        "gptdb.serve.agent.team.layout.agent_operator_resource.AwelAgentConfig",
        "gptdb.agent.core.plan.awel.agent_operator_resource.AWELAgentConfig",
    ],
)
...
@register_resource(
    ...
    alias=[
        "gptdb.serve.agent.team.layout.agent_operator_resource.AwelAgent",
