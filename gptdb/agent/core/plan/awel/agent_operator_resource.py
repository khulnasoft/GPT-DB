...
@register_resource(
    ...
    alias=[
        ...
        "gptdb.agent.plan.awel.agent_operator_resource.AWELAgentResource",
    ],
)
...
@register_resource(
    ...
    alias=[
        ...
        "gptdb.agent.plan.awel.agent_operator_resource.AWELAgentConfig",
    ],
)
...
@register_resource(
    ...
    alias=[
        ...
        "gptdb.agent.plan.awel.agent_operator_resource.AWELAgent",
    ],
)
