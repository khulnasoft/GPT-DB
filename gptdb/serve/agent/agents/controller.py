...
from gptdb.app.gptdb_server import system_app
...
from gptdb.serve.prompt.service import service as PromptService
...
class MultiAgents(BaseComponent, ABC):
    ...
    def init_app(self, system_app: SystemApp):
        ...
        from gptdb.serve.agent.app.controller import gpts_dao
        ...
        **ext_info,
        ...
        if gpts_conversations and len(gpts_conversations) > 0:
            ...
            if last_gpts_conversation.state == Status.WAITING.value:
                ...
                from gptdb.serve.agent.agents.expand.app_start_assisant_agent import (
        ...
        if (
            ...
            from gptdb.app.openapi.api_v1.api_v1 import get_chat_flow
