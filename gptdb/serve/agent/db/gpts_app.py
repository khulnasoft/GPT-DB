...
from gptdb.app.openapi.api_view_model import ConversationVo
...
from gptdb.serve.agent.model import NativeTeamContext
            ...
            if app_info.param_need:
                ...
                if len(resource_params) == 1:
                    ...
                    if resource_param.get("bind_value"):
                        ...
                        from gptdb.app.knowledge.service import (
                            KnowledgeService,
