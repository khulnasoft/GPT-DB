...
from gptdb.core import Embeddings, LLMClient
from gptdb.core.awel import IteratorTrigger, JoinOperator, MapOperator
...
from gptdb.rag.evaluation import RetrieverSimilarityMetric
...
class AgentEvaluator(Evaluator):
    ...
    Examples:
        .. code-block:: python
            ...
            from gptdb.rag.evaluation import (
                RetrieverEvaluator,
