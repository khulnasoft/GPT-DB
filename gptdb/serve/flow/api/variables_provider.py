...
class BuiltinFlowVariablesProvider(BuiltinVariablesProvider):
    ...
    Provide all flows by variables "${gptdb.core.flow.flows}"
    """
...
class BuiltinNodeVariablesProvider(BuiltinVariablesProvider):
    ...
    Provide all nodes by variables "${gptdb.core.flow.nodes}"
    """
...
class BuiltinAllVariablesProvider(BuiltinVariablesProvider):
    ...
    Provide all variables by variables "${gptdb.core.variables}"
    """
...
class BuiltinAllSecretVariablesProvider(BuiltinAllVariablesProvider):
    ...
    Provide all secret variables by variables "${gptdb.core.secrets}"
    """
...
class BuiltinLLMVariablesProvider(BuiltinVariablesProvider):
    ...
    Provide all LLM variables by variables "${gptdb.core.llmv}"
    """
...
class BuiltinEmbeddingsVariablesProvider(BuiltinLLMVariablesProvider):
    ...
    Provide all embeddings variables by variables "${gptdb.core.embeddings}"
    """
...
class BuiltinDatasourceVariablesProvider(BuiltinVariablesProvider):
    ...
    Provide all datasource variables by variables "${gptdb.core.datasource}"
    """
    ...
    def get_variables(
        ...
        """Get the builtin variables."""
        from gptdb.serve.datasource.service.service import (
...
class BuiltinAgentsVariablesProvider(BuiltinVariablesProvider):
    ...
    Provide all agents variables by variables "${gptdb.core.agent.agents}"
    """
...
class BuiltinKnowledgeSpacesVariablesProvider(BuiltinVariablesProvider):
    ...
    Provide all knowledge variables by variables "${gptdb.core.knowledge_spaces}"
    """
    ...
    def get_variables(
        ...
        """Get the builtin variables."""
        from gptdb.serve.rag.service.service import Service, SpaceServeRequest
