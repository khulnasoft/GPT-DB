...
from gptdb.core.awel.flow.flow_factory import FlowPanel, VariablesRequest
from gptdb.core.awel.util.parameter_util import RefreshOptionRequest
...
class RefreshNodeRequest(BaseModel):
    ...
    type_cls: str = Field(
        ...
        examples=["gptdb.core.operator.llm.LLMOperator"],
    )
