...
from gptdb.serve.core import Result, blocking_func_to_async
...
async def install(request: ServeRequest):
    ...
    try:
        from gptdb.serve.gptdbs.my.config import (
            SERVE_SERVICE_COMPONENT_NAME as MY_GPTS_SERVICE_COMPONENT,
        )
        from gptdb.serve.gptdbs.my.service.service import Service as MyGptsService
