...
from gptdb.rag.knowledge.base import Knowledge, KnowledgeType
from gptdb.rag.knowledge.string import StringKnowledge
from gptdb.rag.knowledge.url import URLKnowledge
...
class KnowledgeFactory:
    ...
    def _get_knowledge_subclasses() -> List["Type[Knowledge]"]:
        """Get all knowledge subclasses."""
        from gptdb.rag.knowledge.base import Knowledge  # noqa: F401
        from gptdb.rag.knowledge.csv import CSVKnowledge  # noqa: F401
        from gptdb.rag.knowledge.datasource import DatasourceKnowledge  # noqa: F401
        from gptdb.rag.knowledge.docx import DocxKnowledge  # noqa: F401
        from gptdb.rag.knowledge.excel import ExcelKnowledge  # noqa: F401
        from gptdb.rag.knowledge.html import HTMLKnowledge  # noqa: F401
        from gptdb.rag.knowledge.markdown import MarkdownKnowledge  # noqa: F401
        from gptdb.rag.knowledge.pdf import PDFKnowledge  # noqa: F401
        from gptdb.rag.knowledge.pptx import PPTXKnowledge  # noqa: F401
        from gptdb.rag.knowledge.string import StringKnowledge  # noqa: F401
        from gptdb.rag.knowledge.txt import TXTKnowledge  # noqa: F401
        from gptdb.rag.knowledge.url import URLKnowledge  # noqa: F401
