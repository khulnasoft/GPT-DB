...
def test_md_header_text_splitter() -> None:
    ...
    expected_output = [
        Chunk(
            content='"gptdb-description": my name is gptdb',
            metadata={"Header 1": "gptdb", "Header 2": "description"},
        ),
        Chunk(
            content='"gptdb-content": my name is aries',
            metadata={"Header 1": "gptdb", "Header 2": "content"},
        ),
    ]
