...
from gptdb.core import Chunk, LLMClient, ModelMessageRoleType, ModelRequest
from gptdb.rag.extractor.base import Extractor
from gptdb.util import utils
...
class SummaryExtractor(Extractor):
    ...
    async def _llm_run_tasks(
        ...
        for chunk_text in chunk_texts:
            from gptdb.core import ModelMessage
