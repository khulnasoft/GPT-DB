...
from gptdb.util.parameter_utils import BaseParameters, BaseServerParameters
...
class ModelControllerParameters(BaseServerParameters):
    ...
    log_file: Optional[str] = field(
        default="gptdb_model_controller.log",
        metadata={
            "help": "The filename to store log",
        },
    )
    tracer_file: Optional[str] = field(
        default="gptdb_model_controller_tracer.jsonl",
        metadata={
...
class ModelAPIServerParameters(BaseServerParameters):
    ...
    log_file: Optional[str] = field(
        default="gptdb_model_apiserver.log",
        metadata={
            "help": "The filename to store log",
        },
    )
...
class ModelWorkerParameters(BaseServerParameters, BaseModelParameters):
    ...
    worker_class: Optional[str] = field(
        default=None,
        metadata={"help": "Model worker class, gptdb.model.cluster.DefaultModelWorker"},
    )
    ...
    log_file: Optional[str] = field(
        default="gptdb_model_worker_manager.log",
        metadata={
            "help": "The filename to store log",
        },
    )
    tracer_file: Optional[str] = field(
        default="gptdb_model_worker_manager_tracer.jsonl",
        metadata={
            "help": "The filename to store tracer span records",
        },
    )
...
class ProxyModelParameters(BaseModelParameters):
    ...
    llm_client_class: Optional[str] = field(
        ...
        metadata={
            ...
            "gptdb.model.proxy.llms.proxy_model.ProxyModel"
        },
    )
