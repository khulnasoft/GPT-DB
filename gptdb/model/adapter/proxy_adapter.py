...
from gptdb.model.adapter.base import LLMModelAdapter, register_model_adapter
...
class OllamaLLMModelAdapter(ProxyLLMModelAdapter):
    ...
    def get_generate_stream_function(self, model, model_path: str):
        from gptdb.model.proxy.llms.ollama import ollama_generate_stream
...
class YiProxyLLMModelAdapter(ProxyLLMModelAdapter):
    ...
    def get_async_generate_stream_function(self, model, model_path: str):
        from gptdb.model.proxy.llms.yi import yi_generate_stream
...
class MoonshotProxyLLMModelAdapter(ProxyLLMModelAdapter):
    ...
    def get_async_generate_stream_function(self, model, model_path: str):
        from gptdb.model.proxy.llms.moonshot import moonshot_generate_stream
...
class DeepseekProxyLLMModelAdapter(ProxyLLMModelAdapter):
    ...
    def get_async_generate_stream_function(self, model, model_path: str):
        from gptdb.model.proxy.llms.deepseek import deepseek_generate_stream
...
class SiliconFlowProxyLLMModelAdapter(ProxyLLMModelAdapter):
    ...
    def get_async_generate_stream_function(self, model, model_path: str):
        from gptdb.model.proxy.llms.siliconflow import siliconflow_generate_stream
...
class GiteeProxyLLMModelAdapter(ProxyLLMModelAdapter):
    ...
    def get_async_generate_stream_function(self, model, model_path: str):
        from gptdb.model.proxy.llms.gitee import gitee_generate_stream
