...
from gptdb.model.adapter.template import (
    ConversationAdapter,
...
class LLMModelAdapter(ABC):
    """New Adapter for GPT-DB LLM models"""
    ...
    def _set_conv_converted_messages(
        ...
        if system_messages:
            if len(system_messages) > 1:
                # Compatible with gptdb complex scenarios, the last system will protect more complete information
    ...
    def model_adaptation(
        ...
        # Some model context to gptdb server
        model_context = {
