...
from gptdb.model.parameter import BaseModelParameters
...
def get_llm_model_adapter(
    ...
    from gptdb.model.adapter.proxy_adapter import ProxyLLMModelAdapter
    ...
    if use_fastchat and not must_use_old:
        ...
        from gptdb.app.chat_adapter import get_llm_chat_adapter
        from gptdb.model.adapter.old_adapter import OldLLMModelAdapterWrapper
        from gptdb.model.adapter.old_adapter import (
            get_llm_model_adapter as _old_get_llm_model_adapter,
        )

        logger.info("Use GPT-DB old adapter")
