...
from gptdb._private.pydantic import BaseModel, model_to_dict, model_to_json
...
from gptdb.util.tracer import initialize_tracer, root_tracer
...
def initialize_apiserver(
    ...
    if apiserver_params:
        initialize_tracer(
            ...
            root_operation_name="GPT-DB-APIServer",
