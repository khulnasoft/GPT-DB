...
from gptdb.app.knowledge.chunk_db import DocumentChunkDao, DocumentChunkEntity
from gptdb.app.knowledge.document_db import (
...
from gptdb.app.knowledge.request.response import (
    ChunkQueryResponse,
...
from gptdb.rag.assembler.summary import SummaryAssembler
from gptdb.rag.chunk_manager import ChunkParameters
...
from gptdb.serve.rag.models.models import KnowledgeSpaceDao, KnowledgeSpaceEntity
from gptdb.serve.rag.retriever.knowledge_space import KnowledgeSpaceRetriever
from gptdb.serve.rag.service.service import SyncStatus
...
class KnowledgeService:
    ...
    def _build_default_context(self):
        from gptdb.app.scene.chat_knowledge.v1.prompt import (
            _DEFAULT_TEMPLATE,
            PROMPT_SCENE_DEFINE,
        )
    ...
    async def _llm_extract_summary(
        ...
        """
        from gptdb.app.scene import ChatScene
        ...
        from gptdb.app.openapi.api_v1.api_v1 import CHAT_FACTORY
