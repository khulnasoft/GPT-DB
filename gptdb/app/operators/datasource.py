...
from gptdb.agent.resource.database import DBResource
from gptdb.core import Chunk
from gptdb.core.awel import DAGContext, MapOperator
...
from gptdb.vis.tags.vis_chart import default_chart_type_prompt
...
class HODatasourceDashboardOperator(GPTVisMixin, MapOperator[dict, str]):
    ...
    async def map(self, sql_dict_list: List[dict]) -> str:
        """Execute the context from the datasource."""
        from gptdb.vis.tags.vis_dashboard import VisDashboard
