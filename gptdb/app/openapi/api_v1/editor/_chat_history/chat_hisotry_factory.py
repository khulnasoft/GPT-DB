...
class ChatHistory:
    ...
    def _check_store_type(self, store_type: str):
        ...
        if store_type == "duckdb":
            link1 = (
                "https://docs-gptdb.khulnasoft.com/docs/latest/faq/install#q6-how-to-migrate-meta"
                "-table-chat_history-and-connect_config-from-duckdb-to-sqlite"
            )
            link2 = (
                "https://docs-gptdb.khulnasoft.com/docs/latest/faq/install/#q7-how-to-migrate-"
