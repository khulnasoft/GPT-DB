...
from gptdb.core import BaseOutputParser, ChatPromptTemplate
from gptdb.core._private.example_base import ExampleSelector
...
class AppScenePromptTemplateAdapter(BaseModel):
    ...
    Include some fields that in :class:`gptdb.core.PromptTemplate`
    """
