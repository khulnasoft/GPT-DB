...
from gptdb.core.awel.util.parameter_util import (
    BaseDynamicOptions,
    OptionValue,
    RefreshOptionRequest,
)
from gptdb.core.interface.serialization import Serializable
from gptdb.util.executor_utils import DefaultExecutorFactory, blocking_func_to_async
...
class BaseMetadata(BaseResource):
    ...
    id: str = Field(
        ...
        examples=[
            ...
            "resource_gptdb.model.proxy.llms.chatgpt.OpenAILLMClient",
        ],
    )
...
class ViewMetadata(BaseMetadata):
    ...
    type_cls: Optional[str] = Field(
        ...
        examples=["gptdb.model.operators.LLMOperator"],
    )
