...
from gptdb.core.awel import BaseOperator, MapOperator
...
class PreChatHistoryLoadOperator(
    ...
    In GPT-DB, conversation record and the messages in the conversation are stored in
    the storage,
...
class BufferedConversationMapperOperator(ConversationMapperOperator):
    ...
    Examples:
        .. code-block:: python
            ...
            import asyncio
            from gptdb.core.interface.message import AIMessage, HumanMessage
    ...
    def _filter_round_messages(
        ...
        Examples:
            >>> from gptdb.core import AIMessage, HumanMessage
            >>> from gptdb.core.operators import BufferedConversationMapperOperator
            >>> messages = [
            ...     [
            ...         HumanMessage(content="Hi", round_index=1),
