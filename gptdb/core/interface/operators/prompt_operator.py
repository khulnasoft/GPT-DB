...
from gptdb._private.pydantic import model_validator
from gptdb.core import ModelMessage, ModelOutput, StorageConversation
from gptdb.core.awel import JoinOperator, MapOperator
...
from gptdb.core.interface.message import BaseMessage
from gptdb.core.interface.operators.llm_operator import BaseLLM
from gptdb.core.interface.operators.message_operator import BaseConversationOperator
...
from gptdb.util.function_utils import rearrange_args_by_type
...
class PromptBuilderOperator(
    ...
    Examples:
        .. code-block:: python
            ...
            from gptdb.core.operators import PromptBuilderOperator
