...
from gptdb.util.tracer.span_storage import MemorySpanStorage
...
def initialize_tracer(
    tracer_filename: str,
    root_operation_name: str = "GPT-DB-Webserver",
    ...
    from gptdb.util.tracer.span_storage import FileSpanStorage, SpanStorageContainer
    ...
    if enable_open_telemetry:
        from gptdb.util.tracer.opentelemetry import OpenTelemetrySpanStorage
    ...
    if system_app.app:
        from gptdb.util.tracer.tracer_middleware import TraceIDMiddleware
