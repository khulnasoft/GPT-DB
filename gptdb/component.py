...
class ComponentType(str, Enum):
    WORKER_MANAGER = "gptdb_worker_manager"
    WORKER_MANAGER_FACTORY = "gptdb_worker_manager_factory"
    MODEL_CONTROLLER = "gptdb_model_controller"
    MODEL_REGISTRY = "gptdb_model_registry"
    MODEL_API_SERVER = "gptdb_model_api_server"
    MODEL_CACHE_MANAGER = "gptdb_model_cache_manager"
    PLUGIN_HUB = "gptdb_plugin_hub"
    MULTI_AGENTS = "gptdb_multi_agents"
    EXECUTOR_DEFAULT = "gptdb_thread_pool_default"
    TRACER = "gptdb_tracer"
    TRACER_SPAN_STORAGE = "gptdb_tracer_span_storage"
    RAG_GRAPH_DEFAULT = "gptdb_rag_engine_default"
    AWEL_TRIGGER_MANAGER = "gptdb_awel_trigger_manager"
    AWEL_DAG_MANAGER = "gptdb_awel_dag_manager"
    UNIFIED_METADATA_DB_MANAGER_FACTORY = "gptdb_unified_metadata_db_manager_factory"
...
class SystemApp(LifeCycle):
    ...
    def _build(self):
        ...
        if not self.app:
            ...
            return
        from gptdb.util.fastapi import register_event_handler
