...
if TYPE_CHECKING:
    ...
    from gptdb.datasource.manages import ConnectorManager
...
class Config(metaclass=Singleton):
    ...
    def __init__(self) -> None:
        ...
        self.GPTDB_WEBSERVER_PORT = int(os.getenv("GPTDB_WEBSERVER_PORT", 5670))
        ...
        from gptdb.core._private.prompt_registry import PromptTemplateRegistry
        ...
        # gptdb meta info database connection configuration
        ...
        self.LOCAL_DB_NAME = os.getenv("LOCAL_DB_NAME", "gptdb")
        ...
        # Log level
        self.GPTDB_LOG_LEVEL = os.getenv("GPTDB_LOG_LEVEL", "INFO")
        ...
        self.GPTDB_APP_SCENE_NON_STREAMING_RETRIES_BASE = int(
            os.getenv("GPTDB_APP_SCENE_NON_STREAMING_RETRIES_BASE", 1)
        )
        # Non-streaming scene parallelism
        self.GPTDB_APP_SCENE_NON_STREAMING_PARALLELISM_BASE = int(
            os.getenv("GPTDB_APP_SCENE_NON_STREAMING_PARALLELISM_BASE", 1)
        )
