...
from gptdb.agent.resource import SQLiteDBResource
from gptdb.util.tracer import initialize_tracer
...
async def main():
    ...
    sqlite_resource = SQLiteDBResource("SQLite Database", f"{test_plugin_dir}/gptdb.db")
