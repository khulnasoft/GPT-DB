"""AWEL: Simple rag rewrite example
    ...
    .. code-block:: shell
        ...
        curl -X POST $GPTDB_SERVER/api/v1/awel/trigger/examples/rag/rewrite \
...
from gptdb.rag.operators import QueryRewriteOperator
...
with DAG("gptdb_awel_simple_rag_rewrite_example") as dag:
    trigger = HttpTrigger(
