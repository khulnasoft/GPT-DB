"""AWEL: Data analyst assistant.
    ...
    Examples:
        ...
        .. code-block:: shell
            ...
            MODEL="gpt-3.5-turbo"
            # Fist round
            curl -X POST $GPTDB_SERVER/api/v1/awel/trigger/examples/data_analyst/copilot \
            -H "Content-Type: application/json" -d '{
                "command": "gptdb_awel_data_analyst_code_fix",
                "model": "'"$MODEL"'",
                "stream": false,
                "context": {
...
from gptdb.model.operators import (
    LLMOperator,
...
CODE_DEFAULT = "gptdb_awel_data_analyst_code_default"
CODE_FIX = "gptdb_awel_data_analyst_code_fix"
CODE_PERF = "gptdb_awel_data_analyst_code_perf"
CODE_EXPLAIN = "gptdb_awel_data_analyst_code_explain"
CODE_COMMENT = "gptdb_awel_data_analyst_code_comment"
CODE_TRANSLATE = "gptdb_awel_data_analyst_code_translate"
...
with DAG("gptdb_awel_data_analyst_assistant") as dag:
    trigger = HttpTrigger(
    ...
    keep_start_rounds = int(os.getenv("GPTDB_AWEL_DATA_ANALYST_KEEP_START_ROUNDS", 0))
    keep_end_rounds = int(os.getenv("GPTDB_AWEL_DATA_ANALYST_KEEP_END_ROUNDS", 5))
