-- You can change `gptdb` to your actual metadata database name in your `.env` file
-- eg. `LOCAL_DB_NAME=gptdb`

CREATE
DATABASE IF NOT EXISTS gptdb;
use gptdb;
...
-- gptdb.gptdb_serve_file definition
CREATE TABLE `gptdb_serve_file` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'Auto increment id',
...
-- gptdb.gptdb_serve_variables definition
CREATE TABLE `gptdb_serve_variables` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'Auto increment id',
...
-- gptdb.recommend_question definition
...
-- gptdb.user_recent_apps definition
...
-- gptdb.gptdb_serve_gptdbs_my definition
CREATE TABLE `gptdb_serve_gptdbs_my` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'autoincrement id',
...
-- gptdb.gptdb_serve_gptdbs_hub definition
CREATE TABLE `gptdb_serve_gptdbs_hub` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'autoincrement id',
  `name` varchar(255) NOT NULL COMMENT 'plugin name',
