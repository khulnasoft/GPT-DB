...
[**英語**](README.md) | [**中国語**](README.zh.md) | [**Discord**](https://discord.gg/7uQnPuveTY) | [**ドキュメント**](https://gptdb.khulnasoft.com) | [**微信**](https://github.com/khulnasoft/GPT-DB/blob/main/README.zh.md#%E8%81%94%E7%B3%BB%E6%88%91%E4%BB%AC) | [**コミュニティ**](https://github.com/khulnasoft/community) | [**論文**](https://arxiv.org/pdf/2312.17449.pdf)
...
### AIネイティブデータアプリ
---
- 🔥🔥🔥 [V0.5.0リリース | ワークフローとエージェントを通じてネイティブデータアプリケーションを開発](https://gptdb.khulnasoft.com/docs/changelog/Released_V0.5.0)
---
...
- [GPT-DB-Plugins](https://github.com/khulnasoft/GPT-DB-Plugins) Auto-GPTプラグインを直接実行できるGPT-DBプラグイン
...
[**使用チュートリアル**](http://gptdb.khulnasoft.com/docs/overview)
- [**インストール**](http://gptdb.khulnasoft.com/docs/installation)
  - [Docker](https://gptdb.khulnasoft.com/docs/installation/docker)
  - [ソースコード](https://gptdb.khulnasoft.com/docs/installation/sourcecode)
- [**クイックスタート**](http://gptdb.khulnasoft.com/docs/quickstart)
- [**アプリケーション**](http://gptdb.khulnasoft.com/docs/operation_manual)
  - [アプリの使用](https://gptdb.khulnasoft.com/docs/application/app_usage)
  - [AWELフローの使用](https://gptdb.khulnasoft.com/docs/application/awel_flow_usage)
- [**デバッグ**](http://gptdb.khulnasoft.com/docs/operation_manual/advanced_tutorial/debugging)
- [**高度な使用法**](https://gptdb.khulnasoft.com/docs/application/advanced_tutorial/cli)
  - [SMMF](https://gptdb.khulnasoft.com/docs/application/advanced_tutorial/smmf)
  - [ファインチューニング](https://gptdb.khulnasoft.com/docs/application/fine_tuning_manual/gptdb_hub)
  - [AWEL](https://gptdb.khulnasoft.com/docs/latest/awel/tutorial)
...
- **SMMF（サービス指向マルチモデル管理フレームワーク）**
  ...
  - [サポートされているLLMの詳細](http://gptdb.khulnasoft.com/docs/modules/smmf)
...
- サポートされているデータソース
  - [データソース](http://gptdb.khulnasoft.com/docs/modules/connections)
