...
const pluginViewStatusMapper: Record<GPTDBView['status'], { bgClass: string; icon: React.ReactNode }> = {
  todo: {
    bgClass: 'bg-gray-500',
...
const ChatContent: React.FC<{
  ...
  const { relations, value, cachePluginContext } = useMemo<{ relations: string[]; value: string; cachePluginContext: GPTDBView[] }>(() => {
